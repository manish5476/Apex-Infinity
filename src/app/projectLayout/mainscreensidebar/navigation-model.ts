...
// ─────────────────────────────────────────────────────────────────────────────
// Navigation Model
// Single source of truth for the ERP sidebar navigation configuration.
//
// Rules:
//   • All items are deeply readonly — no mutation allowed after definition.
//   • `items` = nested children (consistent with PrimeNG MenuItem convention).
//   • Permission checks happen in MenuBuilderService, NOT here.
//   • Adding a new item = edit this file only. No component changes needed.
// ─────────────────────────────────────────────────────────────────────────────

/** A single navigation item — leaf or accordion parent. */
...
/** A logical navigation group rendered with a section label (e.g. "ANALYTICS"). */
    ...
    items: [
      {
        ...
        items: [
          ...
          },
          {
            ...
            icon: 'pi pi-book',
            routerLink: ['/notes'],
            permissions: [PERMISSIONS.NOTE.READ],
          },
        ],
      },
    ],
            ...
            items: [
              {
                label: 'Financials',
                icon: 'pi pi-chart-line',
                routerLink: ['/dashboard/finance-main'],
              ...
              },
              {
                ...
                routerLink: ['/dashboard/emi-analytics'],
            ...
            items: [
              {
                label: 'Customer 360',
                icon: 'pi pi-user',
                routerLink: ['/dashboard/customer-360'],
                permissions: [PERMISSIONS.CUSTOMER.READ],
              },
              {
                label: 'Market Segments',
                icon: 'pi pi-sitemap',
                routerLink: ['/dashboard/customer-segmentation'],
                permissions: [PERMISSIONS.ANALYTICS.VIEW_CUSTOMER_SEGMENTATION],
              },
              {
                label: 'LTV Analysis',
                icon: 'pi pi-star',
                routerLink: ['/dashboard/customer-ltv-analysis'],
          ...
          },
          {
            ...
            items: [
              ...
              },
              {
                label: 'Compliance',
                icon: 'pi pi-verified',
                routerLink: ['/dashboard/compliance'],
                permissions: [PERMISSIONS.ANALYTICS.VIEW_SECURITY_AUDIT],
              },
              {
                label: 'Data Health',
                icon: 'pi pi-database',
                routerLink: ['/dashboard/data-health'],
                permissions: [PERMISSIONS.ANALYTICS.VIEW_SECURITY_AUDIT],
              },
            ],
          },
            ...
            items: [
              {
                label: 'Finance Trend',
                icon: 'pi pi-chart-line',
                routerLink: ['/charts/financial'],
                permissions: [PERMISSIONS.ANALYTICS.VIEW_FINANCIAL],
              },
              {
                label: 'Gross Profit',
                icon: 'pi pi-dollar',
                routerLink: ['/charts/gp'],
                permissions: [PERMISSIONS.ANALYTICS.VIEW_FINANCIAL],
              },
              {
                label: 'YoY Growth',
                icon: 'pi pi-arrow-up-right',
                routerLink: ['/charts/growth'],
                permissions: [PERMISSIONS.ANALYTICS.VIEW_FINANCIAL],
              },
              {
                label: 'Payment Mix',
                icon: 'pi pi-credit-card',
                routerLink: ['/charts/payment'],
                permissions: [PERMISSIONS.ANALYTICS.VIEW_FINANCIAL],
              },
              {
                label: 'Purchase/Sales',
                icon: 'pi pi-sync',
                routerLink: ['/charts/pvs'],
                permissions: [PERMISSIONS.ANALYTICS.VIEW_FINANCIAL],
              },
              {
                label: 'EMI Portfolio',
                icon: 'pi pi-calendar',
                routerLink: ['/charts/emi'],
                permissions: [PERMISSIONS.ANALYTICS.EMI_READ],
              },
            ],
          },
            ...
            items: [
              {
                label: 'AOV Trend',
                icon: 'pi pi-chart-line',
                routerLink: ['/charts/aov'],
                permissions: [PERMISSIONS.ANALYTICS.VIEW_FORECAST],
              },
              {
                label: 'Sales Dist',
                icon: 'pi pi-globe',
                routerLink: ['/charts/dist'],
                permissions: [PERMISSIONS.ANALYTICS.VIEW_FORECAST],
              },
              {
                label: 'Return Rate',
                icon: 'pi pi-replay',
                routerLink: ['/charts/return'],
                permissions: [PERMISSIONS.ANALYTICS.VIEW_FORECAST],
              },
              {
                label: 'Performers',
                icon: 'pi pi-star',
                routerLink: ['/charts/performers'],
                permissions: [PERMISSIONS.ANALYTICS.VIEW_EXECUTIVE],
              },
              {
                label: 'Order Funnel',
                icon: 'pi pi-filter-fill',
                routerLink: ['/charts/funnel'],
                permissions: [PERMISSIONS.ANALYTICS.VIEW_FORECAST],
              },
            ],
          },
            ...
            items: [
              {
                ...
                routerLink: ['/charts/acquisition'],
                permissions: [PERMISSIONS.CUSTOMER.READ],
              },
              {
                label: 'Outstanding',
                icon: 'pi pi-money-bill',
                routerLink: ['/charts/outstanding'],
                permissions: [PERMISSIONS.CUSTOMER.READ],
              },
              {
                label: 'Branch Radar',
                icon: 'pi pi-map-marker',
                routerLink: ['/charts/radar'],
                permissions: [PERMISSIONS.ANALYTICS.VIEW_BRANCH_COMPARISON],
              },
              {
                label: 'Activity Heatmap',
                icon: 'pi pi-th-large',
                routerLink: ['/charts/heatmap'],
                permissions: [PERMISSIONS.ANALYTICS.VIEW_OPERATIONAL],
              },
              {
                label: 'Inventory Health',
                icon: 'pi pi-box',
                routerLink: ['/charts/inventory'],
                permissions: [PERMISSIONS.ANALYTICS.VIEW_INVENTORY],
              },
            ],
          },
        ...
        items: [
          {
            ...
            items: [
              ...
              },
              {
                label: 'Scan Invoice',
                icon: 'pi pi-plus',
                routerLink: ['/invoices/PosInvoiceComponent'],
              ...
              },
              {
                ...
                routerLink: ['/invoices/profitDashboardNew'],
                permissions: [PERMISSIONS.REPORT.PROFIT],
              },
              {
                label: 'Profit Summary',
                icon: 'pi pi-file-excel',
                routerLink: ['/invoices/ProfitSummaryComponent'],
                permissions: [PERMISSIONS.REPORT.PROFIT],
              },
              {
                label: 'Advanced Analysis',
                icon: 'pi pi-chart-bar',
                routerLink: ['/invoices/AdvancedProfitAnalysisComponent'],
                permissions: [PERMISSIONS.REPORT.PROFIT],
              },
            ],
          },
          {
            ...
            icon: 'pi pi-users',
            routerLink: ['/customer/analyticsCustomer'],
            permissions: [PERMISSIONS.CUSTOMER.READ],
          },
          {
            label: 'Customers',
        ...
        items: [
          {
            ...
            items: [
              ...
              },
              {
                ...
                routerLink: ['/product/reports/low-stock'],
                permissions: [PERMISSIONS.PRODUCT.READ],
              },
            ],
          },
          {
            ...
            items: [
              ...
              },
              {
                ...
                icon: 'pi pi-replay',
                routerLink: ['/purchase/returns'],
                permissions: [PERMISSIONS.PURCHASE.RETURN],
              },
            ],
          },
          {
        ...
        items: [
          {
            ...
            icon: 'pi pi-home',
            routerLink: ['/storefront/overview'],
            permissions: [PERMISSIONS.STOREFRONT.READ],
          },
          {
            label: 'Analytics Overview',
            icon: 'pi pi-chart-line',
            routerLink: ['/storefront/analytics'],
            permissions: [PERMISSIONS.STOREFRONT.READ],
          },
          {
            label: 'Sales Reports',
            icon: 'pi pi-file-excel',
            routerLink: ['/storefront/reports/sales'],
            permissions: [PERMISSIONS.STOREFRONT.READ],
          },
          {
            label: 'Page Builder',
            icon: 'pi pi-sitemap',
            routerLink: ['/storefront/pages'],
            permissions: [PERMISSIONS.STOREFRONT.READ],
          },
          {
            label: 'Templates Library',
            icon: 'pi pi-clone',
            routerLink: ['/storefront/templates'],
            permissions: [PERMISSIONS.STOREFRONT.READ],
          },
          {
            label: 'Media Manager',
            icon: 'pi pi-image',
            routerLink: ['/storefront/media'],
            permissions: [PERMISSIONS.STOREFRONT.READ],
          },
          {
            label: 'Orders',
            icon: 'pi pi-receipt',
            routerLink: ['/storefront/orders'],
            permissions: [PERMISSIONS.STOREFRONT.READ],
          },
          {
            label: 'Abandoned Carts',
            icon: 'pi pi-shopping-cart',
            routerLink: ['/storefront/abandoned-carts'],
            permissions: [PERMISSIONS.STOREFRONT.READ],
          },
          {
            label: 'Delivery Agents',
            icon: 'pi pi-truck',
            routerLink: ['/storefront/delivery-agents'],
            permissions: [PERMISSIONS.STOREFRONT.READ],
          },
          {
            label: 'Customers',
            icon: 'pi pi-users',
            routerLink: ['/storefront/customers'],
            permissions: [PERMISSIONS.STOREFRONT.READ],
          },
          {
            label: 'Customer Segments',
            icon: 'pi pi-users',
            routerLink: ['/storefront/segments'],
            permissions: [PERMISSIONS.STOREFRONT.READ],
          },
          {
            label: 'Coupons',
            icon: 'pi pi-ticket',
            routerLink: ['/storefront/coupons'],
            permissions: [PERMISSIONS.STOREFRONT.READ],
          },
          {
            label: 'Discount Manager',
            icon: 'pi pi-percentage',
            routerLink: ['/storefront/discounts'],
            permissions: [PERMISSIONS.STOREFRONT.READ],
          },
          {
            label: 'SEO Dashboard',
            icon: 'pi pi-search',
            routerLink: ['/storefront/seo'],
            permissions: [PERMISSIONS.STOREFRONT.READ],
          },
          {
            label: 'Design & Layout',
            ...
            items: [
              {
                label: 'Themes',
                icon: 'pi pi-images',
                routerLink: ['/storefront/themes'],
                permissions: [PERMISSIONS.STOREFRONT.THEME_MANAGE],
              },
              {
                label: 'Master Layout',
                icon: 'pi pi-desktop',
                routerLink: ['/storefront/settings/layout'],
                permissions: [PERMISSIONS.STOREFRONT.LAYOUT_MANAGE],
              },
            ],
          },
          {
            ...
            items: [
              {
                ...
                icon: 'pi pi-cog',
                routerLink: ['/storefront/settings'],
                permissions: [PERMISSIONS.STOREFRONT.READ],
              },
              {
                label: 'Domain Settings',
                icon: 'pi pi-globe',
                routerLink: ['/storefront/domains'],
                permissions: [PERMISSIONS.STOREFRONT.READ],
              },
              {
                label: 'Integrations',
                icon: 'pi pi-link',
                routerLink: ['/storefront/integrations'],
                permissions: [PERMISSIONS.STOREFRONT.READ],
              },
              {
                label: 'Role Management',
                icon: 'pi pi-users',
                routerLink: ['/storefront/roles'],
                permissions: [PERMISSIONS.STOREFRONT.READ],
              },
              {
                label: 'Billing',
                icon: 'pi pi-credit-card',
                routerLink: ['/storefront/billing'],
                permissions: [PERMISSIONS.STOREFRONT.READ],
              },
            ],
          },
            ...
            items: [
              {
                label: 'Activity Logs',
                icon: 'pi pi-history',
                routerLink: ['/storefront/activity'],
                permissions: [PERMISSIONS.STOREFRONT.READ],
              },
              {
                label: 'Audit History',
                icon: 'pi pi-history',
                routerLink: ['/storefront/audit-history'],
                permissions: [PERMISSIONS.STOREFRONT.READ],
              },
              {
                label: 'Notifications Center',
                icon: 'pi pi-bell',
                routerLink: ['/storefront/notifications'],
                permissions: [PERMISSIONS.STOREFRONT.READ],
              },
              {
                label: 'Publish History',
                icon: 'pi pi-cloud-upload',
                routerLink: ['/storefront/publish-history'],
                permissions: [PERMISSIONS.STOREFRONT.READ],
              },
              {
                label: 'Page Revisions',
                icon: 'pi pi-file-edit',
                routerLink: ['/storefront/revisions'],
                permissions: [PERMISSIONS.STOREFRONT.READ],
              },
            ],
          },
    ...
    items: [
      {
        ...
        permissions: [
          ...
          PERMISSIONS.NOTE.VIEW_ANALYTICS,
          PERMISSIONS.NOTE.VIEW_CALENDAR,
        ...
        items: [
          ...
          },
          {
            ...
            permissions: [PERMISSIONS.NOTE.VIEW_ANALYTICS],
          },
          {
            label: 'Notes List',
            icon: 'pi pi-list',
          ...
          },
          {
            ...
            permissions: [PERMISSIONS.NOTE.VIEW_CALENDAR],
          },
          {
            label: 'Meetings',
            icon: 'pi pi-video',
            ...
            items: [
              {
                label: 'My Attendance',
                icon: 'pi pi-clock',
                routerLink: ['/hrms/attendance/my-clock'],
                permissions: [PERMISSIONS.ATTENDANCE.READ],
              },
              {
                label: 'My Timesheet',
                icon: 'pi pi-calendar',
                routerLink: ['/hrms/daily-attendance/my-timesheet'],
                permissions: [PERMISSIONS.ATTENDANCE.READ],
              },
              {
                label: 'Leave Center',
                icon: 'pi pi-calendar-minus',
                routerLink: ['/hrms/leave/hub'],
                permissions: [PERMISSIONS.LEAVE.READ],
              },
            ],
          },
          {
            ...
            items: [
              ...
              },
              {
                label: 'Live Punches',
                icon: 'pi pi-bolt',
                routerLink: ['/hrms/attendance/live-feed'],
                permissions: [PERMISSIONS.ATTENDANCE.MANAGE],
              },
              {
                label: 'Attendance Admin',
                icon: 'pi pi-shield',
                routerLink: ['/hrms/attendance/admin'],
                permissions: [PERMISSIONS.ATTENDANCE.MANAGE],
              },
              {
                label: 'HR Reports',
                icon: 'pi pi-chart-bar',
                routerLink: ['/hrms/daily-attendance/reports'],
                permissions: [PERMISSIONS.ATTENDANCE.MANAGE],
              },
              {
                label: 'Leave Admin',
                icon: 'pi pi-calendar-plus',
                routerLink: ['/hrms/leave/admin'],
                permissions: [PERMISSIONS.LEAVE.ADMIN],
              },
            ],
          },
          {
            ...
            items: [
              ...
              },
              {
                ...
                icon: 'pi pi-user-plus',
                routerLink: ['/hrms/shift-groups/list'],
                permissions: [PERMISSIONS.SHIFT.GROUP_READ],
              },
              {
                label: 'Geofencing',
                icon: 'pi pi-map-marker',
                routerLink: ['/hrms/geofence/hub'],
                permissions: [PERMISSIONS.ATTENDANCE.MANAGE],
              },
              {
                label: 'Biometrics',
                icon: 'pi pi-fingerprint',
                routerLink: ['/hrms/attendance/machines/hub'],
                permissions: [PERMISSIONS.ATTENDANCE.MANAGE],
              },
              {
        ...
        items: [
          {
            ...
            permissions: [PERMISSIONS.ORG.MANAGE],
          },
          {
            label: 'Branches',
            icon: 'pi pi-map-marker',
          ...
          },
          {
            ...
            icon: 'pi pi-wifi',
            routerLink: ['/sessions'],
            permissions: [PERMISSIONS.SESSION.VIEW_ALL],
          },
          {
            label: 'Assets',
            icon: 'pi pi-box',
            routerLink: ['/assets'],
            permissions: [PERMISSIONS.ASSET.READ],
          },
        ],
      },
    ],
