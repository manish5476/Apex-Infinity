...
//   desc: string;
//   group: string;
//   icon: string; // PrimeIcon class (e.g. 'pi-chart-line')
//   tags: string;
// }
...
//   ) {
//     // Note: 'effect' for Lucide icons removed as PrimeIcons 
//     // are handled via CSS classes in the template.
//   }
