import { Component, OnInit, AfterViewInit, HostListener, signal, computed, OnDestroy } from '@angular/core';
...
export class LandingComponent implements OnInit, AfterViewInit, OnDestroy {
  ...
  animatedStats = signal<Stat[]>([
    { label: 'Businesses', value: 5000, suffix: '+', currentValue: 0, icon: 'fas fa-building', color: 'linear-gradient(135deg, #3b82f6, #60a5fa)' },
    { label: 'Invoices/Day', value: 25000, suffix: '', currentValue: 0, icon: 'fas fa-file-invoice', color: 'linear-gradient(135deg, #10b981, #34d399)' },
    { label: 'Uptime', value: 99.9, suffix: '%', currentValue: 0, icon: 'fas fa-server', color: 'linear-gradient(135deg, #8b5cf6, #a78bfa)' },
    { label: 'Growth', value: 32, suffix: '%', currentValue: 0, icon: 'fas fa-chart-line', color: 'linear-gradient(135deg, #f59e0b, #fbbf24)' }
  ]);

  // Categories
  categories = ['All', 'Finance', 'Inventory', 'CRM', 'Attendance', 'Payroll', 'Communication'];

  // Bento Grid Features with positions
  features: Feature[] = [
    {
      title: 'Double-Entry Accounting',
      desc: 'Automated ledger entries, GST compliance & financial reports',
      group: 'Finance',
    ...
    },
    {
      ...
      desc: 'Multi-location tracking with auto reorder points',
      group: 'Inventory',
      icon: 'fas fa-boxes',
      color: 'green',
    ...
    },
    {
      ...
      desc: 'Biometric sync, shift management & real-time monitoring',
      group: 'Attendance',
    ...
    },
    {
      ...
      desc: 'Real-time chat, announcements & file sharing',
      group: 'Communication',
    ...
    },
    {
      ...
      desc: 'Flexible payment plans with automated reminders',
      group: 'Finance',
    ...
    },
    {
      ...
      desc: 'Auto salary calculation with tax deductions',
      group: 'Payroll',
  ...
  integrations: Integration[] = [
    { name: 'Razorpay', icon: 'fas fa-credit-card', color: '#528FF0' },
    ...
    { name: 'Shopify', icon: 'fas fa-store', color: '#96BF48' },
    { name: 'QuickBooks', icon: 'fas fa-book', color: '#2CA01C' }
  ];
  ...
  testimonials: Testimonial[] = [
    {
      ...
      content: 'Inventory costs reduced by 40% and our cash flow improved dramatically.',
    ...
    },
    {
      ...
      content: 'Real-time GST reports saved us 20+ hours monthly. Game changer!',
    ...
    },
    {
      ...
      content: 'Payroll processing went from 2 days to 2 hours. Incredible efficiency.',
  ...
  plans = [
    {
      ...
      features: ['5 Users', '100 Invoices/Month', 'Basic Inventory', 'Email Support'],
      cta: 'Get Started',
      popular: false,
    ...
    },
    {
      ...
      features: ['25 Users', 'Unlimited Invoices', 'Advanced Analytics', 'API Access', 'Priority Support'],
    ...
    },
    {
      ...
      features: ['Unlimited Users', 'Custom Modules', 'Dedicated Support', 'On-Premise', 'Custom Integrations'],
      cta: 'Contact Sales',
      popular: false,
  ...
  private updateParallax() {
    ...
    elements.forEach((el, index) => {
      ...
      (el as HTMLElement).style.transform = 
        `translateX(${this.mouseX * depth}px) translateY(${this.mouseY * depth}px)`;
    });
  }
  ...
  private initObservers() {
    ...
    document.querySelectorAll('.observe').forEach(el => this.observer?.observe(el));
  }
  ...
  private animateCounter(index: number, target: number, duration: number) {
    ...
    const update = () => {
      ...
      updated[index] = { ...updated[index], currentValue: current };
  ...
  getCounterValue(stat: Stat): string {
    if (!stat.currentValue) return `0${stat.suffix}`;
    
    if (stat.value >= 1000000) {
      const millions = stat.currentValue / 1000000;
      return `${millions.toFixed(millions < 10 ? 1 : 0)}M${stat.suffix}`;
    }
    
    if (stat.value >= 1000) {
      const thousands = stat.currentValue / 1000;
      return `${thousands.toFixed(thousands < 10 ? 1 : 0)}K${stat.suffix}`;
    }
    
    return `${stat.currentValue}${stat.suffix}`;
  }
  ...
  getFeatureGridStyle(feature: Feature): any {
    ...
    return {
      'grid-row': `${feature.position.row} / span ${feature.position.span || 1}`,
      'grid-column': `${feature.position.column} / span ${feature.position.span || 1}`
    };
  }
}
// import { Component, OnInit, AfterViewInit, HostListener, signal, computed, OnDestroy } from '@angular/core';
...
//   isYearly = signal(false);
//   animatedStats = signal<Stat[]>([
//     { label: 'Businesses Trust Us', value: 5000, suffix: '+', currentValue: 0 },
//     { label: 'Invoices Processed', value: 2500000, suffix: '+', currentValue: 0 },
//     { label: 'Revenue Growth', value: 32, suffix: '%', currentValue: 0 },
//     { label: 'System Uptime', value: 99.9, suffix: '%', currentValue: 0 }
//   ]);

//   // Features based on your models
//   categories = ['All', 'Finance', 'Inventory', 'CRM', 'Attendance', 'Payroll', 'Communication'];

//   features: Feature[] = [
//     {
//       title: 'Double-Entry Accounting',
//       desc: 'Complete ledger system with automatic journal entries, GST compliance, and financial reports.',
//       group: 'Finance',
//       icon: 'fas fa-calculator',
//       color: 'blue'
//     },
//     {
//       title: 'Real-Time Inventory',
//       desc: 'Track stock across branches with automated reorder points and batch management.',
//       group: 'Inventory',
//       icon: 'fas fa-boxes',
//       color: 'green'
//     },
...
//       desc: 'Complete CRM with credit limits, outstanding tracking, and 360° customer views.',
//       group: 'CRM',
//       icon: 'fas fa-users',
//       color: 'purple'
//     },
...
//       desc: 'Biometric integration, shift management, leave tracking, and real-time monitoring.',
//       group: 'Attendance',
//       icon: 'fas fa-fingerprint',
//       color: 'orange'
//     },
...
//       desc: 'Calculate salaries, deductions, taxes, and generate payslips automatically.',
//       group: 'Payroll',
//       icon: 'fas fa-money-bill-wave',
//       color: 'teal'
//     },
...
//       desc: 'Real-time chat, announcements, file sharing, and task management.',
//       group: 'Communication',
//       icon: 'fas fa-comments',
//       color: 'pink'
//     },
...
//       desc: 'Create flexible payment plans, track installments, and automate reminders.',
//       group: 'Finance',
//       icon: 'fas fa-calendar-alt',
//       color: 'blue'
//     },
...
//       desc: 'End-to-end procurement with supplier tracking and purchase history.',
//       group: 'Inventory',
...
//       desc: 'Create professional invoices, track payments, and manage sales returns.',
//       group: 'CRM',
//       icon: 'fas fa-file-invoice',
//       color: 'purple'
//     },
//     {
//       title: 'Shift & Holiday Management',
//       desc: 'Define shifts, manage holidays, and handle overtime calculations.',
//       group: 'Attendance',
//       icon: 'fas fa-clock',
//       color: 'orange'
//     },
...
//       desc: 'Create custom business rules and automate repetitive tasks.',
//       group: 'Finance',
//       icon: 'fas fa-bolt',
//       color: 'blue'
//     },
...
//       desc: 'Organize notes, tasks, meetings, and collaborate with teams.',
//       group: 'Communication',
...
//       role: 'CEO',
//       company: 'RetailChain India',
//       content: 'Switching to Apex Infinity transformed our business. We reduced inventory costs by 40% and improved cash flow management significantly.',
//       avatar: 'assets/avatars/1.jpg',
//       rating: 5
//     },
//     {
...
//       role: 'Finance Manager',
//       company: 'Manufacturing Corp',
//       content: 'The accounting module is incredible. Real-time GST reports saved us hours of manual work every month.',
//       avatar: 'assets/avatars/2.jpg',
//       rating: 5
//     },
//     {
...
//       role: 'Operations Head',
//       company: 'Logistics Hub',
//       content: 'Attendance and payroll integration is seamless. Our HR team now processes salaries in 2 hours instead of 2 days.',
//       avatar: 'assets/avatars/3.jpg',
//       rating: 4
//     }
//   ];
...
//       name: 'Startup',
//       price: 'Free',
//       desc: 'For small businesses just starting',
//       features: ['Up to 5 users', '100 invoices/month', 'Basic inventory', 'Email support'],
//       cta: 'Get Started',
//       color: 'light-blue'
//     },
//     {
...
//       price: '₹2,499',
//       desc: 'For growing businesses',
//       features: ['Up to 25 users', 'Unlimited invoices', 'Advanced analytics', 'Priority support', 'API access'],
//       cta: 'Start Free Trial',
//       popular: true,
//       color: 'blue'
//     },
...
//       price: 'Custom',
//       desc: 'For large organizations',
//       features: ['Unlimited users', 'Custom modules', 'Dedicated support', 'On-premise deployment', 'Custom integrations'],
//       cta: 'Contact Sales',
//       color: 'dark-blue'
//     }
//   ];
