...
//     CommonModule, ReactiveFormsModule, FormsModule,
//     ButtonModule, InputTextModule, DialogModule, ToastModule, 
//     ConfirmDialogModule, ToggleSwitchModule, DatePicker,
//     AgShareGrid
//   ],
//   providers: [MessageService, ConfirmationService, DatePipe],
//   templateUrl: './holiday-manager.component.html',
...
//         field: '_id',
//         width: 100,
//         cellRenderer: ActionViewRenderer, // Reusing your renderer
//       },
...
//           `<span style="color: #2ecc71; font-weight:bold">Mandatory</span>`
//       },
//       { field: 'description', headerName: 'Description', flex: 2 }
//     ];
//   }
...
//   fetchData() {
//     this.isLoading = true;
//     this.holidayService.getHolidays({ year: new Date().getFullYear() }).subscribe({
//       next: (res: any) => {
...
//       error: () => {
//         this.isLoading = false;
//         this.messageService.add({ severity: 'error', summary: 'Error', detail: 'Could not load holidays' });
//       }
//     });
//   }
...
//     this.holidayForm.patchValue({
//       name: rowData.name,
//       date: new Date(rowData.date), // Convert string to Date for PrimeNG Calendar
//       description: rowData.description,
//       isOptional: rowData.isOptional
//     });
//     this.showDialog = true;
...
//   handleGridEvent(event: any) {
//     if (event.type === 'cellClicked' && event.colDef.headerName === 'Actions') {
//       // In a real app, check if clicked edit or delete icon
//       // For now, assuming row click opens edit
//       this.openEdit(event.data); 
//     }
//     // Implement delete trigger logic here based on your ActionRenderer implementation
//   }
// }