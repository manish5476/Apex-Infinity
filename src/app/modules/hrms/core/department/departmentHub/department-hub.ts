...
@Component({
        ...
        @if (isLoading()) {
          ...
          <div class="workspace-card">
            ...
            <div class="custom-tabs-wrapper">
              ...
              <div class="custom-tabpanels">
                
                @if (activeTab() === '0') {
                  <div class="panel-inner scroll-container fade-in-fast">
  ...
  styles: [`
    ...
    /* ── PURE HTML TABS (Billion-Dollar UI) ───────────── */
    .custom-tabs-wrapper {
      display: flex;
      flex-direction: column;
      height: 100%;
    ...
    .custom-tablist::-webkit-scrollbar { display: none; }
    ...
    @media (max-width: 768px) {
      ...
      .custom-tablist { padding: 0 var(--spacing-lg); gap: var(--spacing-lg); }
    }
  `]
})
