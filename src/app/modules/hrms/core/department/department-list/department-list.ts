  ...
  template: `
    <div class="list-page-wrapper">
      <header class="page-header">
        <div class="header-content">
          ...
          <div class="header-actions">
            <button class="btn btn-primary btn-with-icon" (click)="createNew()">
        ...
        <div class="filter-glass-panel">
          <div class="filter-group">
            <div class="input-container">
              ...
              <input type="text" [(ngModel)]="deptFilter.search" (keyup.enter)="applyFilters()" placeholder="Search by name or code..." class="se-input" />
            </div>

            <div class="select-container">
              <select [(ngModel)]="deptFilter.branchId" (change)="applyFilters()" class="se-input">
            ...
            <div class="select-container">
              <select [(ngModel)]="deptFilter.isActive" (change)="applyFilters()" class="se-input">
            ...
            <button class="btn-icon-only" (click)="resetFilters()" title="Reset Filters">
      ...
      <footer class="list-footer">
        <span class="count-badge">Total Departments: <strong>{{totalCount}}</strong></span>
      </footer>
    </div>
  `,
  styles: [`
    ...
    .se-input {
      ...
      padding: 0 var(--spacing-lg) 0 34px;
      font-size: var(--font-size-sm);
      color: var(--text-primary);
...
export class DepartmentListComponent implements OnInit {
    ...
    this.column = [
      {
        ...
        cellRenderer: (params: any) => `
          <div style="display: flex; flex-direction: column; justify-content: center; height: 100%;">
            <span style="font-weight: 600; color: var(--text-primary); font-size: 13px;">${params.value}</span>
            <span style="font-size: 10px; color: var(--text-tertiary);">${params.data.code || ''}</span>
          </div>
        `
      },
      {
      ...
      },
      {
        ...
        cellRenderer: (params: any) => params.value ? `
          <div style="display:flex; align-items:center; gap: 8px;">
            <div style="width:24px; height:24px; border-radius:50%; background:var(--accent-focus); color:var(--color-primary); display:flex; align-items:center; justify-content:center; font-size:10px; font-weight:bold;">
      ...
      },
      {
        ...
        cellRenderer: (params: any) => `
          <div style="display:flex; align-items:center; gap:4px;">
            <span style="font-weight:700; color:var(--color-primary)">${params.value || 0}</span>
            <span style="color:var(--text-tertiary); font-size:10px;">/ ${params.data.maxStrength || '∞'}</span>
          </div>
        `
      },
      {
        ...
        cellRenderer: (params: any) => {
          ...
          const statusClass = isActive ? 'color-success' : 'color-error';
          const dotColor = isActive ? 'var(--color-success)' : 'var(--color-error)';
          return `
            <div style="display:flex; align-items:center; gap:6px;">
              <span style="width:6px; height:6px; border-radius:50%; background:${dotColor}"></span>
              <span style="font-size:11px; font-weight:600; text-transform:uppercase; color:${dotColor}">
  ...
  eventFromGrid(event: any) {
    ...
    if (event.type === 'cellClicked') this.router.navigate(['/hrms/department/details', deptId]);
    if (event.type === 'editStart') this.router.navigate(['/hrms/department/edit', deptId]);
