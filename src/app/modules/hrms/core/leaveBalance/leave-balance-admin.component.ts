...
@Component({
  ...
  template: `
    ...
    <p-dialog [modal]="true" header="Bulk Initialize Financial Year" [(visible)]="displayBulkDialog" [modal]="true" [style]="{width: '450px'}" appendTo="body" [blockScroll]="true" [breakpoints]="{'1199px': '75vw', '575px': '90vw'}" [dismissableMask]="true">
    ...
    <p-dialog [modal]="true" header="Adjust Leave Balance" [(visible)]="displayAdjustDialog" [modal]="true" [style]="{width: '450px'}" appendTo="body" [blockScroll]="true" [breakpoints]="{'1199px': '75vw', '575px': '90vw'}" [dismissableMask]="true">
