...
export class HRMSService extends BaseApiService {
  ...
  getDepartments(params?: any): Observable<{ status: string; data: { departments: Department[] } }> {
    return this.get<{ status: string; data: { departments: Department[] } }>('/hrms/departments', params);
  }
  ...
  getDepartmentHierarchy(): Observable<{ status: string; data: { hierarchy: DepartmentTree[] } }> {
    return this.get<{ status: string; data: { hierarchy: DepartmentTree[] } }>('/hrms/departments/hierarchy');
  }
  ...
  getDepartmentTree(): Observable<{ status: string; data: { departments: DepartmentTree[] } }> {
    return this.get<{ status: string; data: { departments: DepartmentTree[] } }>('/hrms/departments?tree=true');
  }
  ...
  getDepartmentStats(): Observable<{ status: string; data: { stats: any } }> {
    return this.get<{ status: string; data: { stats: any } }>('/hrms/departments/stats/summary');
  }
  ...
  getDepartment(id: string): Observable<{ status: string; data: { department: Department } }> {
    return this.get<{ status: string; data: { department: Department } }>(`/hrms/departments/${id}`);
  }
  ...
  createDepartment(data: Partial<Department>): Observable<{ status: string; data: { department: Department } }> {
    return this.post<{ status: string; data: { department: Department } }>('/hrms/departments', data);
  }
  ...
  updateDepartment(id: string, data: Partial<Department>): Observable<{ status: string; data: { department: Department } }> {
    return this.patch<{ status: string; data: { department: Department } }>(`/hrms/departments/${id}`, data);
  }
  ...
  deleteDepartment(id: string): Observable<{ status: string; data: null }> {
    return this.delete<{ status: string; data: null }>(`/hrms/departments/${id}`);
  }
  ...
  getDepartmentEmployees(id: string, params?: any): Observable<{ status: string; data: { employees: any[] } }> {
    return this.get<{ status: string; data: { employees: any[] } }>(`/hrms/departments/${id}/employees`, params);
  }
  ...
  bulkUpdateDepartments(operations: any[]): Observable<{ status: string; data: any }> {
    return this.post<{ status: string; data: any }>('/hrms/departments/bulk', { operations });
  }
  ...
  getDesignations(params?: any): Observable<{ status: string; data: { designations: Designation[] } }> {
    return this.get<{ status: string; data: { designations: Designation[] } }>('/hrms/designations', params);
  }
  ...
  getDesignationHierarchy(): Observable<{ status: string; data: any }> {
    return this.get<{ status: string; data: any }>('/hrms/designations/hierarchy');
  }
  ...
  getSalaryBands(): Observable<{ status: string; data: { internal: SalaryBand[]; marketRates: any } }> {
    return this.get<{ status: string; data: { internal: SalaryBand[]; marketRates: any } }>('/hrms/designations/salary-bands');
  }
  ...
  getPromotionEligible(designationId: string, years?: number): Observable<{ status: string; data: any }> {
    ...
    return this.get<{ status: string; data: any }>('/hrms/designations/promotion-eligible', params);
  }
  ...
  getDesignation(id: string): Observable<{ status: string; data: { designation: Designation } }> {
    return this.get<{ status: string; data: { designation: Designation } }>(`/hrms/designations/${id}`);
  }
  ...
  getCareerPath(id: string): Observable<{ status: string; data: any }> {
    return this.get<{ status: string; data: any }>(`/hrms/designations/career-path/${id}`);
  }
  ...
  getDesignationEmployees(id: string, params?: any): Observable<{ status: string; data: { employees: any[] } }> {
    return this.get<{ status: string; data: { employees: any[] } }>(`/hrms/designations/${id}/employees`, params);
  }
  ...
  createDesignation(data: Partial<Designation>): Observable<{ status: string; data: { designation: Designation } }> {
    return this.post<{ status: string; data: { designation: Designation } }>('/hrms/designations', data);
  }
  ...
  updateDesignation(id: string, data: Partial<Designation>): Observable<{ status: string; data: { designation: Designation } }> {
    return this.patch<{ status: string; data: { designation: Designation } }>(`/hrms/designations/${id}`, data);
  }
  ...
  deleteDesignation(id: string): Observable<{ status: string; data: null }> {
    return this.delete<{ status: string; data: null }>(`/hrms/designations/${id}`);
  }
  ...
  bulkCreateDesignations(designations: Partial<Designation>[]): Observable<{ status: string; data: any }> {
    return this.post<{ status: string; data: any }>('/hrms/designations/bulk', { designations });
  }
  ...
  getShifts(params?: any): Observable<{ status: string; data: { shifts: Shift[] } }> {
    return this.get<{ status: string; data: { shifts: Shift[] } }>('/hrms/shifts', params);
  }
  ...
  getShiftCoverage(date?: Date): Observable<{ status: string; data: { coverage: any[] } }> {
    ...
    return this.get<{ status: string; data: { coverage: any[] } }>('/hrms/shifts/coverage', params);
  }
  ...
  getShiftTimeline(date?: Date): Observable<{ status: string; data: { timeline: any[] } }> {
    const params = date ? { date: date.toISOString().split('T')[0] } : {};
    return this.get<{ status: string; data: { timeline: any[] } }>('/hrms/shifts/timeline', params);
  }
  ...
  calculateShiftHours(data: { startTime: string; endTime: string; breaks?: any[] }): Observable<{ status: string; data: any }> {
    return this.post<{ status: string; data: any }>('/hrms/shifts/calculate-hours', data);
  }
  ...
  validateShiftAssignment(data: { shiftId: string; userId: string; date?: Date }): Observable<{ status: string; data: any }> {
    return this.post<{ status: string; data: any }>('/hrms/shifts/validate-assignment', data);
  }
  ...
  getShift(id: string): Observable<{ status: string; data: { shift: Shift } }> {
    return this.get<{ status: string; data: { shift: Shift } }>(`/hrms/shifts/${id}`);
  }
  ...
  getShiftAssignments(id: string, params?: any): Observable<{ status: string; data: { users: any[] } }> {
    return this.get<{ status: string; data: { users: any[] } }>(`/hrms/shifts/${id}/assignments`, params);
  }
  ...
  createShift(data: Partial<Shift>): Observable<{ status: string; data: { shift: Shift } }> {
    return this.post<{ status: string; data: { shift: Shift } }>('/hrms/shifts', data);
  }
  ...
  updateShift(id: string, data: Partial<Shift>): Observable<{ status: string; data: { shift: Shift } }> {
    return this.patch<{ status: string; data: { shift: Shift } }>(`/hrms/shifts/${id}`, data);
  }
  ...
  deleteShift(id: string): Observable<{ status: string; data: null }> {
    return this.delete<{ status: string; data: null }>(`/hrms/shifts/${id}`);
  }
  ...
  cloneShift(id: string): Observable<{ status: string; data: { shift: Shift } }> {
    return this.post<{ status: string; data: { shift: Shift } }>(`/hrms/shifts/${id}/clone`, {});
  }
  ...
  getShiftGroups(params?: any): Observable<{ status: string; data: { shiftGroups: ShiftGroup[] } }> {
    return this.get<{ status: string; data: { shiftGroups: ShiftGroup[] } }>('/hrms/shift-groups', params);
  }
  ...
  getShiftGroup(id: string): Observable<{ status: string; data: { shiftGroup: ShiftGroup } }> {
    return this.get<{ status: string; data: { shiftGroup: ShiftGroup } }>(`/hrms/shift-groups/${id}`);
  }
  ...
  createShiftGroup(data: Partial<ShiftGroup>): Observable<{ status: string; data: { shiftGroup: ShiftGroup } }> {
    return this.post<{ status: string; data: { shiftGroup: ShiftGroup } }>('/hrms/shift-groups', data);
  }
  ...
  updateShiftGroup(id: string, data: Partial<ShiftGroup>): Observable<{ status: string; data: { shiftGroup: ShiftGroup } }> {
    return this.patch<{ status: string; data: { shiftGroup: ShiftGroup } }>(`/hrms/shift-groups/${id}`, data);
  }
  ...
  deleteShiftGroup(id: string): Observable<{ status: string; data: null }> {
    return this.delete<{ status: string; data: null }>(`/hrms/shift-groups/${id}`);
  }
  ...
  generateRotationSchedule(id: string, data: { startDate: Date; endDate: Date; userIds?: string[] }): Observable<{ status: string; data: any }> {
    return this.post<{ status: string; data: any }>(`/hrms/shift-groups/${id}/generate-schedule`, data);
  }
  ...
  assignGroupToUsers(id: string, data: { userIds: string[]; startDate: Date; endDate?: Date }): Observable<{ status: string; data: any }> {
    return this.post<{ status: string; data: any }>(`/hrms/shift-groups/${id}/assign`, data);
  }
  ...
  getGroupAssignments(id: string): Observable<{ status: string; data: { assignments: ShiftAssignment[] } }> {
    return this.get<{ status: string; data: { assignments: ShiftAssignment[] } }>(`/hrms/shift-groups/${id}/assignments`);
  }
  ...
  getLeaveRequests(params?: any): Observable<{ status: string; data: { leaveRequests: LeaveRequest[] } }> {
    return this.get<{ status: string; data: { leaveRequests: LeaveRequest[] } }>('/hrms/leave-requests', params);
  }
  ...
  getMyLeaveRequests(params?: any): Observable<{ status: string; data: { leaveRequests: LeaveRequest[] } }> {
    return this.get<{ status: string; data: { leaveRequests: LeaveRequest[] } }>('/hrms/leave-requests/my-requests', params);
  }
  ...
  getPendingApprovals(): Observable<{ status: string; data: any }> {
    return this.get<{ status: string; data: any }>('/hrms/leave-requests/pending-approvals');
  }
  ...
  getLeaveBalanceSummary(financialYear?: string): Observable<{ status: string; data: LeaveBalanceSummary }> {
    ...
    return this.get<{ status: string; data: LeaveBalanceSummary }>('/hrms/leave-requests/balance-summary', params);
  }
  ...
  getTeamLeaveCalendar(month?: number, year?: number): Observable<{ status: string; data: any }> {
    ...
    return this.get<{ status: string; data: any }>('/hrms/leave-requests/team-calendar', params);
  }
  ...
  getLeaveAnalytics(financialYear?: string, departmentId?: string): Observable<{ status: string; data: any }> {
    ...
    return this.get<{ status: string; data: any }>('/hrms/leave-requests/analytics', params);
  }
  ...
  getLeaveRequest(id: string): Observable<{ status: string; data: { leaveRequest: LeaveRequest } }> {
    return this.get<{ status: string; data: { leaveRequest: LeaveRequest } }>(`/hrms/leave-requests/${id}`);
  }
  ...
  createLeaveRequest(data: Partial<LeaveRequest>): Observable<{ status: string; data: { leaveRequest: LeaveRequest } }> {
    return this.post<{ status: string; data: { leaveRequest: LeaveRequest } }>('/hrms/leave-requests', data);
  }
  ...
  updateLeaveRequest(id: string, data: Partial<LeaveRequest>): Observable<{ status: string; data: { leaveRequest: LeaveRequest } }> {
    return this.patch<{ status: string; data: { leaveRequest: LeaveRequest } }>(`/hrms/leave-requests/${id}`, data);
  }
  ...
  cancelLeaveRequest(id: string): Observable<{ status: string; data: { leaveRequest: LeaveRequest } }> {
    return this.delete<{ status: string; data: { leaveRequest: LeaveRequest } }>(`/hrms/leave-requests/${id}`);
  }
  ...
  approveLeaveRequest(id: string, comments?: string): Observable<{ status: string; data: { leaveRequest: LeaveRequest } }> {
    return this.patch<{ status: string; data: { leaveRequest: LeaveRequest } }>(`/hrms/leave-requests/${id}/approve`, { comments });
  }
  ...
  rejectLeaveRequest(id: string, reason: string): Observable<{ status: string; data: { leaveRequest: LeaveRequest } }> {
    return this.patch<{ status: string; data: { leaveRequest: LeaveRequest } }>(`/hrms/leave-requests/${id}/reject`, { reason });
  }
  ...
  escalateLeaveRequest(id: string, data: { reason: string; escalateTo: string }): Observable<{ status: string; data: { leaveRequest: LeaveRequest } }> {
    return this.patch<{ status: string; data: { leaveRequest: LeaveRequest } }>(`/hrms/leave-requests/${id}/escalate`, data);
  }
  ...
  bulkApproveLeaves(requestIds: string[], comments?: string): Observable<{ status: string; data: any }> {
    return this.post<{ status: string; data: any }>('/hrms/leave-requests/bulk-approve', { requestIds, comments });
  }
  ...
  getAllLeaveBalances(params?: any): Observable<{ status: string; data: { leaveBalances: LeaveBalance[] } }> {
    return this.get<{ status: string; data: { leaveBalances: LeaveBalance[] } }>('/hrms/leave-balances', params);
  }
  ...
  getMyLeaveBalance(financialYear?: string): Observable<{ status: string; data: LeaveBalance }> {
    const params = financialYear ? { financialYear } : {};
    return this.get<{ status: string; data: LeaveBalance }>('/hrms/leave-balances/my-balance', params);
  }
  ...
  getLeaveBalanceReport(financialYear?: string, departmentId?: string): Observable<{ status: string; data: any }> {
    ...
    if (financialYear) params.financialYear = financialYear;
    if (departmentId) params.departmentId = departmentId;
    return this.get<{ status: string; data: any }>('/hrms/leave-balances/report', params);
  }
  ...
  getUtilizationTrends(years?: number): Observable<{ status: string; data: any }> {
    ...
    return this.get<{ status: string; data: any }>('/hrms/leave-balances/utilization-trends', params);
  }
  ...
  getLeaveBalance(id: string): Observable<{ status: string; data: { leaveBalance: LeaveBalance } }> {
    return this.get<{ status: string; data: { leaveBalance: LeaveBalance } }>(`/hrms/leave-balances/${id}`);
  }
  ...
  updateLeaveBalance(id: string, data: any): Observable<{ status: string; data: { leaveBalance: LeaveBalance } }> {
    return this.patch<{ status: string; data: { leaveBalance: LeaveBalance } }>(`/hrms/leave-balances/${id}`, data);
  }
  ...
  initializeLeaveBalance(userId: string, financialYear?: string): Observable<{ status: string; data: { leaveBalance: LeaveBalance } }> {
    return this.post<{ status: string; data: { leaveBalance: LeaveBalance } }>('/hrms/leave-balances/initialize', { userId, financialYear });
  }
  ...
  bulkInitializeLeaveBalances(financialYear: string, carryForward?: boolean): Observable<{ status: string; data: any }> {
    return this.post<{ status: string; data: any }>('/hrms/leave-balances/bulk-initialize', { financialYear, carryForward });
  }
  ...
  getAttendanceLogs(params?: any): Observable<{ status: string; data: { logs: AttendanceLog[] } }> {
    return this.get<{ status: string; data: { logs: AttendanceLog[] } }>('/hrms/attendance/logs', params);
  }
  ...
  getMyLogs(params?: any): Observable<{ status: string; data: { logs: AttendanceLog[]; summary: any } }> {
    return this.get<{ status: string; data: { logs: AttendanceLog[]; summary: any } }>('/hrms/attendance/logs/my-logs', params);
  }
  ...
  getUserLogs(userId: string, params?: any): Observable<{ status: string; data: { logs: AttendanceLog[] } }> {
    return this.get<{ status: string; data: { logs: AttendanceLog[] } }>(`/hrms/attendance/logs/user/${userId}`, params);
  }
  ...
  getLogStats(fromDate?: Date, toDate?: Date): Observable<{ status: string; data: any }> {
    ...
    return this.get<{ status: string; data: any }>('/hrms/attendance/logs/stats', params);
  }
  ...
  getRealtimeFeed(limit?: number): Observable<{ status: string; data: any }> {
    ...
    return this.get<{ status: string; data: any }>('/hrms/attendance/logs/realtime-feed', params);
  }
  ...
  createAttendanceLog(data: Partial<AttendanceLog>): Observable<{ status: string; data: { log: AttendanceLog; daily: any } }> {
    return this.post<{ status: string; data: { log: AttendanceLog; daily: any } }>('/hrms/attendance/logs', data);
  }
  ...
  getAttendanceLog(id: string): Observable<{ status: string; data: { log: AttendanceLog } }> {
    return this.get<{ status: string; data: { log: AttendanceLog } }>(`/hrms/attendance/logs/${id}`);
  }
  ...
  verifyLog(id: string): Observable<{ status: string; data: { log: AttendanceLog } }> {
    return this.patch<{ status: string; data: { log: AttendanceLog } }>(`/hrms/attendance/logs/${id}/verify`, {});
  }
  ...
  flagLog(id: string, reason: string): Observable<{ status: string; data: { log: AttendanceLog } }> {
    return this.patch<{ status: string; data: { log: AttendanceLog } }>(`/hrms/attendance/logs/${id}/flag`, { reason });
  }
  ...
  correctLog(id: string, data: { timestamp: Date; type: string; reason: string }): Observable<{ status: string; data: any }> {
    return this.patch<{ status: string; data: any }>(`/hrms/attendance/logs/${id}/correct`, data);
  }
  ...
  getAllDailyAttendance(params?: any): Observable<{ status: string; data: { records: AttendanceDaily[] } }> {
    return this.get<{ status: string; data: { records: AttendanceDaily[] } }>('/hrms/attendance/daily', params);
  }
  ...
  getMyAttendance(params?: any): Observable<{ status: string; data: { records: AttendanceDaily[]; summary: any } }> {
    return this.get<{ status: string; data: { records: AttendanceDaily[]; summary: any } }>('/hrms/attendance/daily/my-attendance', params);
  }
  ...
  getTodayAttendance(): Observable<{ status: string; data: AttendanceDaily & { todaysLogs: AttendanceLog[] } }> {
    return this.get<{ status: string; data: AttendanceDaily & { todaysLogs: AttendanceLog[] } }>('/hrms/attendance/daily/today');
  }
  ...
  getAttendanceDashboard(date?: Date): Observable<{ status: string; data: AttendanceDashboard }> {
    const params = date ? { date: date.toISOString().split('T')[0] } : {};
    return this.get<{ status: string; data: AttendanceDashboard }>('/hrms/attendance/daily/dashboard', params);
  }
  ...
  getAttendanceReport(params: { fromDate: Date; toDate: Date; departmentId?: string; userId?: string }): Observable<{ status: string; data: AttendanceReport }> {
    ...
    return this.get<{ status: string; data: AttendanceReport }>('/hrms/attendance/daily/report', queryParams);
  }
  ...
  getAttendanceTrends(months?: number): Observable<{ status: string; data: any }> {
    ...
    return this.get<{ status: string; data: any }>('/hrms/attendance/daily/trends', params);
  }
  ...
  exportAttendance(params: { fromDate: Date; toDate: Date; format?: 'json' | 'csv' }): Observable<any> {
    ...
    return this.get<any>('/hrms/attendance/daily/export', queryParams);
  }
  ...
  getDailyAttendance(id: string): Observable<{ status: string; data: { daily: AttendanceDaily } }> {
    return this.get<{ status: string; data: { daily: AttendanceDaily } }>(`/hrms/attendance/daily/${id}`);
  }
  ...
  regularizeAttendance(id: string, data: { firstIn?: Date; lastOut?: Date; status?: string; reason: string }): Observable<{ status: string; data: { daily: AttendanceDaily } }> {
    return this.patch<{ status: string; data: { daily: AttendanceDaily } }>(`/hrms/attendance/daily/${id}/regularize`, data);
  }
  ...
  bulkUpdateAttendance(updates: any[]): Observable<{ status: string; data: any }> {
    return this.post<{ status: string; data: any }>('/hrms/attendance/daily/bulk-update', { updates });
  }
  ...
  recalculateDaily(date: Date): Observable<{ status: string; data: any }> {
    return this.post<{ status: string; data: any }>('/hrms/attendance/daily/recalculate', { date });
  }
  ...
  getMachines(params?: any): Observable<{ status: string; data: { machines: AttendanceMachine[] } }> {
    return this.get<{ status: string; data: { machines: AttendanceMachine[] } }>('/hrms/attendance/machines', params);
  }
  ...
  getMachineAnalytics(days?: number): Observable<{ status: string; data: any }> {
    ...
    return this.get<{ status: string; data: any }>('/hrms/attendance/machines/analytics', params);
  }
  ...
  getUnmappedUsers(): Observable<{ status: string; data: { users: any[] } }> {
    return this.get<{ status: string; data: { users: any[] } }>('/hrms/attendance/machines/unmapped-users');
  }
  ...
  getMachine(id: string): Observable<{ status: string; data: { machine: AttendanceMachine } }> {
    return this.get<{ status: string; data: { machine: AttendanceMachine } }>(`/hrms/attendance/machines/${id}`);
  }
  ...
  getMachineStatus(id: string): Observable<{ status: string; data: MachineStatus }> {
    return this.get<{ status: string; data: MachineStatus }>(`/hrms/attendance/machines/${id}/status`);
  }
  ...
  getMachineLogs(id: string, params?: any): Observable<{ status: string; data: { logs: AttendanceLog[] } }> {
    return this.get<{ status: string; data: { logs: AttendanceLog[] } }>(`/hrms/attendance/machines/${id}/logs`, params);
  }
  ...
  createMachine(data: Partial<AttendanceMachine>): Observable<{ status: string; data: { machine: AttendanceMachine; apiKey: string } }> {
    return this.post<{ status: string; data: { machine: AttendanceMachine; apiKey: string } }>('/hrms/attendance/machines', data);
  }
  ...
  updateMachine(id: string, data: Partial<AttendanceMachine>): Observable<{ status: string; data: { machine: AttendanceMachine } }> {
    return this.patch<{ status: string; data: { machine: AttendanceMachine } }>(`/hrms/attendance/machines/${id}`, data);
  }
  ...
  deleteMachine(id: string): Observable<{ status: string; data: null }> {
    return this.delete<{ status: string; data: null }>(`/hrms/attendance/machines/${id}`);
  }
  ...
  testMachineConnection(id: string): Observable<{ status: string; data: any }> {
    return this.post<{ status: string; data: any }>(`/hrms/attendance/machines/${id}/test-connection`, {});
  }
  ...
  regenerateMachineApiKey(id: string): Observable<{ status: string; data: { machine: any; apiKey: string } }> {
    return this.post<{ status: string; data: { machine: any; apiKey: string } }>(`/hrms/attendance/machines/${id}/regenerate-key`, {});
  }
  ...
  mapUserToMachine(data: { userId: string; machineUserId: string }): Observable<{ status: string; data: { user: any } }> {
    return this.post<{ status: string; data: { user: any } }>('/hrms/attendance/machines/map-user', data);
  }
  ...
  bulkMapUsers(mappings: Array<{ userId: string; machineUserId: string }>, deviceId?: string): Observable<{ status: string; data: any }> {
    return this.post<{ status: string; data: any }>('/hrms/attendance/machines/bulk-map', { mappings, deviceId });
  }
  ...
  bulkUpdateMachineStatus(data: { machineIds: string[]; status: string; reason?: string }): Observable<{ status: string; data: any }> {
    return this.post<{ status: string; data: any }>('/hrms/attendance/machines/bulk-status', data);
  }
  ...
  getGeoFences(params?: any): Observable<{ status: string; data: { geofences: GeoFence[] } }> {
    return this.get<{ status: string; data: { geofences: GeoFence[] } }>('/hrms/attendance/geofences', params);
  }
  ...
  getGeoFenceViolations(params?: { fromDate?: Date; toDate?: Date; userId?: string }): Observable<{ status: string; data: any }> {
    ...
    if (params?.userId) queryParams.userId = params.userId;
    return this.get<{ status: string; data: any }>('/hrms/attendance/geofences/violations', queryParams);
  }
  ...
  findNearbyGeofences(coordinates: [number, number], radius?: number): Observable<{ status: string; data: { geofences: any[] } }> {
    return this.post<{ status: string; data: { geofences: any[] } }>('/hrms/attendance/geofences/nearby', {
  ...
  getGeoFence(id: string): Observable<{ status: string; data: { geofence: GeoFence } }> {
    return this.get<{ status: string; data: { geofence: GeoFence } }>(`/hrms/attendance/geofences/${id}`);
  }
  ...
  getGeoFenceStats(id: string, days?: number): Observable<{ status: string; data: any }> {
    const params = days ? { days } : {};
    return this.get<{ status: string; data: any }>(`/hrms/attendance/geofences/${id}/stats`, params);
  }
  ...
  checkGeoFencePoint(id: string, coordinates: [number, number]): Observable<{ status: string; data: GeoFenceCheck }> {
    return this.post<{ status: string; data: GeoFenceCheck }>(`/hrms/attendance/geofences/${id}/check-point`, {
      longitude: coordinates[0],
      latitude: coordinates[1]
    });
  }
  ...
  createGeoFence(data: Partial<GeoFence>): Observable<{ status: string; data: { geofence: GeoFence } }> {
    return this.post<{ status: string; data: { geofence: GeoFence } }>('/hrms/attendance/geofences', data);
  }
  ...
  updateGeoFence(id: string, data: Partial<GeoFence>): Observable<{ status: string; data: { geofence: GeoFence } }> {
    return this.patch<{ status: string; data: { geofence: GeoFence } }>(`/hrms/attendance/geofences/${id}`, data);
  }
  ...
  deleteGeoFence(id: string): Observable<{ status: string; data: null }> {
    return this.delete<{ status: string; data: null }>(`/hrms/attendance/geofences/${id}`);
  }
  ...
  assignGeoFenceToUsers(id: string, userIds: string[]): Observable<{ status: string; data: any }> {
    return this.post<{ status: string; data: any }>(`/hrms/attendance/geofences/${id}/assign-users`, { userIds });
  }
  ...
  assignGeoFenceToDepartments(id: string, departmentIds: string[]): Observable<{ status: string; data: any }> {
    return this.post<{ status: string; data: any }>(`/hrms/attendance/geofences/${id}/assign-departments`, { departmentIds });
  }
  ...
  getHolidays(params?: any): Observable<{ status: string; data: { holidays: Holiday[] } }> {
    return this.get<{ status: string; data: { holidays: Holiday[] } }>('/hrms/attendance/holidays', params);
  }
  ...
  getHolidaysByYear(year: number, branchId?: string): Observable<{ status: string; data: { holidays: Holiday[]; byMonth: any } }> {
    ...
    return this.get<{ status: string; data: { holidays: Holiday[]; byMonth: any } }>(`/hrms/attendance/holidays/year/${year}`, params);
  }
  ...
  getUpcomingHolidays(limit?: number): Observable<{ status: string; data: { holidays: Holiday[] } }> {
    const params = limit ? { limit } : {};
    return this.get<{ status: string; data: { holidays: Holiday[] } }>('/hrms/attendance/holidays/upcoming', params);
  }
  ...
  getHolidayStats(year?: number): Observable<{ status: string; data: any }> {
    ...
    return this.get<{ status: string; data: any }>('/hrms/attendance/holidays/stats', params);
  }
  ...
  exportHolidayCalendar(year?: number, branchId?: string, format?: 'json' | 'calendar'): Observable<any> {
    ...
    return this.get<any>('/hrms/attendance/holidays/export', params);
  }
  ...
  checkHoliday(date: Date, branchId?: string): Observable<{ status: string; data: { isHoliday: boolean; holiday: Holiday | null } }> {
    return this.post<{ status: string; data: { isHoliday: boolean; holiday: Holiday | null } }>('/hrms/attendance/holidays/check-date', {
  ...
  getHoliday(id: string): Observable<{ status: string; data: { holiday: Holiday } }> {
    return this.get<{ status: string; data: { holiday: Holiday } }>(`/hrms/attendance/holidays/${id}`);
  }
  ...
  createHoliday(data: Partial<Holiday>): Observable<{ status: string; data: { holiday: Holiday } }> {
    return this.post<{ status: string; data: { holiday: Holiday } }>('/hrms/attendance/holidays', data);
  }
  ...
  updateHoliday(id: string, data: Partial<Holiday>): Observable<{ status: string; data: { holiday: Holiday } }> {
    return this.patch<{ status: string; data: { holiday: Holiday } }>(`/hrms/attendance/holidays/${id}`, data);
  }
  ...
  deleteHoliday(id: string): Observable<{ status: string; data: null }> {
    return this.delete<{ status: string; data: null }>(`/hrms/attendance/holidays/${id}`);
  }
  ...
  bulkCreateHolidays(holidays: Partial<Holiday>[], year?: number): Observable<{ status: string; data: any }> {
    return this.post<{ status: string; data: any }>('/hrms/attendance/holidays/bulk', { holidays, year });
  }
  ...
  copyHolidaysFromYear(fromYear: number, toYear: number, branchId?: string): Observable<{ status: string; data: any }> {
    return this.post<{ status: string; data: any }>('/hrms/attendance/holidays/copy-year', { fromYear, toYear, branchId });
  }
}