...
<div class="auth-root">
  <aside class="brand-panel">
    ...
    <div class="brand-inner">
      ...
      <div class="hero-copy">
        <p class="overline-text">Secure Access</p>
        ...
        <p class="hero-body">
          Make sure to use a strong password that you don't use on other websites.
        </p>
      </div>
  ...
  <main class="form-panel" id="main-content">
    <div class="form-inner">
      <div class="form-header">
        ...
        <p class="form-subtitle">Enter your new password to regain access to your delivery dashboard.</p>
      </div>
      ...
      @if (!successMessage) {
        ...
        <form (ngSubmit)="onSubmit()" #resetForm="ngForm" class="auth-form" novalidate>
          <div class="field-group">
            <label class="field-label" for="password">New Password</label>
            <input type="password" id="password" name="password" [(ngModel)]="password" required minlength="8" class="apex-input" placeholder="At least 8 characters">
          </div>

          <div class="field-group">
            <label class="field-label" for="confirmPassword">Confirm Password</label>
            <input type="password" id="confirmPassword" name="confirmPassword" [(ngModel)]="confirmPassword" required class="apex-input" placeholder="Confirm new password">
          </div>

          <button type="submit" class="submit-btn" [class.loading]="loading" [disabled]="resetForm.invalid || loading">
            @if (loading) {
      ...
      @if (successMessage) {
        <div style="text-align: center; padding: 2rem 0;">
          ...
          <h3 style="font-family: 'DM Serif Display', serif; font-size: 1.5rem; margin-bottom: 0.5rem; color: var(--text-primary);">Password Reset!</h3>
