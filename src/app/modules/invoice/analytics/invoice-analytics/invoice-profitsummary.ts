...
@Component({
      ...
      @else if (data(); as summary) {
        ...
        <div class="kpi-grid">
          ...
          <div class="kpi-card cost-card">
            ...
            <div class="card-value text-tertiary">
        ...
        <div class="section-card">
          ...
          <div class="metrics-grid">
            ...
            <div class="metric-item highlight">
              ...
              <span class="metric-value text-success">{{ summary.metrics.averageProfitPerInvoice | currency:'INR':'symbol':'1.0-0' }}</span>
            </div>
  ...
  styles: [`
    ...
    .sub-text { font-weight: 500; }

    /* Profit Card Specifics */
    .profit-card {
      border-color: var(--theme-accent-secondary); /* Subtle highlight */
      .icon-box {
        background: var(--color-success-bg);
        color: var(--theme-success);
      }
    ...
    .metric-item {
      ...
      &:hover { border-color: var(--theme-border-secondary); }
      
      &.highlight {
        background: var(--color-success-bg);
        border-color: var(--color-success-border);
        .metric-label { color: var(--theme-success); opacity: 0.9; }
      }
    }
    ...
    .empty-icon { font-size: 2rem; margin-bottom: var(--spacing-md); opacity: 0.5; }
    ...
    @media (max-width: 768px) {
      ...
      .card-value { font-size: var(--font-size-2xl); }
    }
  `]
})
