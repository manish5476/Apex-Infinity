...
@Component({
  ...
  styles: [`
    ...
    .grid-toolbar {
      ...
      background: var(--bg-primary); /* Keep toolbar white/surface colored */
    ...
    .grid-body {
      ...
      ::ng-deep .premium-grid {
        ...
        /* Use a slightly darker shade for the header to separate it from the rows */
        --ag-header-background-color: var(--component-bg-hover, var(--bg-secondary));
