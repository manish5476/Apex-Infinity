...
//         @case ('color') {
//            <div class="flex items-center gap-2">
//              <div class="w-4 h-4 rounded-full border border-primary" [style.background-color]="value"></div>
//              <span>{{ value }}</span>
//            </div>
//         }
...
//     /* Utility Classes mapped to Theme Tokens */
//     .text-success  { color: var(--color-success); }
//     .text-error    { color: var(--color-error); }
//     .text-primary  { color: var(--theme-text-primary); }
//     .text-secondary{ color: var(--theme-text-secondary); }
//     .text-tertiary { color: var(--theme-text-tertiary); opacity: 0.5; }
//     .font-mono     { font-family: var(--font-mono); }

//     /* Custom Badge Overrides for p-tag */
//     ::ng-deep .custom-badge {
//       font-size: 11px;
//       font-weight: 700;
//       padding: 2px 8px;
...
//   // Simple helper to map values to badge classes
//   getSeverityClass(val: string): string {
//     const v = (val || '').toLowerCase();
//     if (['active', 'paid', 'approved', 'completed'].includes(v)) return 'badge-success';
//     if (['pending', 'processing', 'draft'].includes(v)) return 'badge-warning';
