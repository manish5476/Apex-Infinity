...
//     this.allNotes().forEach((note:any) => note.tags?.forEach((t:any) => tags.add(t)));
...
//     if (query) {
//       notes = notes.filter((n:any) => n.title?.toLowerCase().includes(query) || n.content.toLowerCase().includes(query));
//     }
//     if (this.filterTag() !== 'all') {
//       notes = notes.filter((n:any) => n.tags?.includes(this.filterTag()));
//     }
//     return notes;
//   });
...
//     this.filteredNotes().forEach((note:any) => {
...
//     });
//     this.imagePreviews = note.attachments.map((a:any) => ({ url: a.url }));
//     this.isEditorVisible = true;
//   }
...
//     return this.allNotes().filter((note:any) => {
//       const noteDate = new Date(note.noteDate);
//       return noteDate.getMonth() === currentMonth && 
//              noteDate.getFullYear() === currentYear;
//     }).length;
...
//   getPinnedCount(): number {
//     return this.allNotes().filter((note:any) => note.isPinned).length;
//   }

//   getHighPriorityCount(): number {
//     return this.allNotes().filter((note:any) => note.importance === 'high').length;
//   }
  

//   getUpcomingNotes(): any[] {
//     const today = new Date();
