...
//                 @if (note.relatedNotes?.length) {
//                   <div class="links-grid">
//                     @for (link of note.relatedNotes; track link._id) {
//                       <!-- Assuming relatedNotes is populated, otherwise needs a safe check -->
//                       <div class="link-card" routerLink="/notes/{{link._id}}">
//                         <i class="pi pi-link"></i>
//                         <span class="link-title">{{ link['title'] || 'Untitled Note' }}</span>
//                         <button class="btn-unlink" (click)="$event.stopPropagation(); unlinkNote(link._id)">×</button>
//                       </div>
//                     }
//                   </div>
//                 } @else {
