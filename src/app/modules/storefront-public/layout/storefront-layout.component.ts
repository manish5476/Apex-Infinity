...
//       <div class="fixed top-[-10%] right-[-10%] w-[600px] h-[600px] rounded-full bg-rose-300/10 blur-[100px] pointer-events-none z-0"></div>
...
//       <main class="flex-grow w-full relative z-10 flex flex-col transition-all duration-500"
//             [class.pt-32]="!isHomePage()" 
//             [class.pt-0]="isHomePage()">
...
//   `,
//   styles: [`
//     /* Global Font Settings for "Premium" Readability */
//     :host {
//       display: block;
//       -webkit-font-smoothing: antialiased;
//       -moz-osx-font-smoothing: grayscale;
...
//     /* Mobile Bottom Dock Glass Effect */
//     .glass-dock {
//       background: rgba(255, 255, 255, 0.85);
//       backdrop-filter: blur(16px);
//       -webkit-backdrop-filter: blur(16px);
...
//     ).subscribe((event: any) => {
//       this.currentUrl = event.url;
//       // Scroll to top on route change for that "SPA" feel
//       window.scrollTo({ top: 0, behavior: 'smooth' });
//     });
//   }
