...
export class SplitContentComponent {
  ...
  readonly cfg = computed(() => ({
    ...
    title: (this._config().typography?.headingText || this._config().title) ?? 'Crafted with Purpose',
    content: (this._config().typography?.subText || this._config().content) ?? 'Every detail matters. We combine thoughtful design with premium materials.',
