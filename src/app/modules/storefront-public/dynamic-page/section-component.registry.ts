...
export const SECTION_COMPONENT_REGISTRY: Record<string, SectionRenderEntry> = {
  ...
  // --- Product & Commerce ---
  product_slider: { load: () => import('../pages/product-slider/product-slider.component').then(m => m.ProductSliderComponent), inputs: (s, o) => ({ config: s.config, data: resolver.resolveProducts(s), organizationSlug: o }) },
  product_grid: { load: () => import('../pages/product-grid/product-grid.component').then(m => m.ProductGridComponent), inputs: (s, o) => ({ config: s.config, data: resolver.resolveProducts(s), orgSlug: o }) },
  product_listing: { load: () => import('../pages/product-listing/product-listing.component').then(m => m.ProductListingComponent), inputs: (s, o) => ({ config: s.config, products: resolver.resolveProducts(s) }) },
  featured_product: { load: () => import('../pages/featured-product/featured-product').then(m => m.FeaturedProductComponent), inputs: s => ({ config: s.config, product: resolver.resolveData(s) }) },
  category_grid: { load: () => import('../pages/category-grid/category-grid.component').then(m => m.CategoryGridComponent), inputs: (s, o) => ({ config: s.config, categories: resolver.resolveCategories(s), orgSlug: o }) },
  ...
  blog_feed: { load: () => import('../pages/blog-feed/blog-feed.component').then(m => m.BlogFeedComponent), inputs: s => ({ config: s.config, posts: resolver.resolvePosts(s) }) },
  ...
  map_locations: { load: () => import('../pages/map-locations/map-locations.component').then(m => m.MapLocationsComponent), inputs: s => ({ config: s.config, locations: resolver.resolveLocations(s) }) },
...
export const SECTION_RUNTIME_TYPES = Object.keys(SECTION_COMPONENT_REGISTRY);// import { Type } from '@angular/core';
// import { SectionDataResolverService } from '../services/section-data-resolver.service';
