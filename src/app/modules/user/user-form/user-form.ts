          ...
          <div class="form-body custom-scrollbar">
            ...
            <div class="content-container">
                ...
                <div class="form-grid">
                    ...
                    <div class="field-group">
                      <label>Branch</label>
                      <app-master-dropdown endpoint="branches" formControlName="branchId" placeholder="Global / HQ"></app-master-dropdown>
                    </div>
                ...
                <div class="form-grid">
                    ...
                    <!-- 🟢 LIVE DATA: Departments -->
                    <div class="field-group">
                      <label>Department</label>
                      <app-master-dropdown endpoint="departments" formControlName="departmentId" placeholder="Select Dept"></app-master-dropdown>
                    </div>

                    <!-- 🟢 LIVE DATA: Designations -->
                    <div class="field-group">
                      <label>Designation</label>
                      <app-master-dropdown endpoint="designations" formControlName="designationId" placeholder="Select Designation"></app-master-dropdown>
                    </div>

                    <!-- 🟢 LIVE DATA: Managers -->
                    <div class="field-group">
                      <label>Reporting Manager</label>
                      <app-master-dropdown endpoint="users" formControlName="reportingManagerId" placeholder="Select Manager"></app-master-dropdown>
                    </div>
                ...
                <div *ngIf="userForm.get('attendanceConfig.isAttendanceEnabled')?.value" class="animate-content mt-6">
                    <div class="form-grid mb-6">
                      <div class="field-group">
                          ...
                          <!-- 🟢 LIVE DATA: Shifts -->
                          <app-master-dropdown endpoint="shifts" formControlName="shiftId" placeholder="Select Shift"></app-master-dropdown>
                      </div>
                      <div class="field-group">
                      ...
                      <div class="field-group">
                          ...
                          <!-- 🟢 LIVE DATA: GeoFences (Assuming 'masters' endpoint) -->
                          <app-master-dropdown endpoint="geofencing" formControlName="geoFenceId" placeholder="Select Zone"></app-master-dropdown>
                      </div>
                      <div class="field-group">
