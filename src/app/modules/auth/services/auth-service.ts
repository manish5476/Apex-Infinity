...
// //   public handleLoginSuccess(response: any, rememberMe: boolean = false, returnUrl?: string): void {
// //     const user = response.data?.user;
// //     const token = response.token;
// //     if (!token || !user) return;
...
// //     if (user.status === 'approved') {
// //       // 🚀 Wait for full permissions before navigating to prevent "No Access" guards
// //       this.refreshPermissions().subscribe({
// //         next: () => {
// //           this.router.navigateByUrl(returnUrl || '/dashboard');
// //         },
// //         error: () => {
// //           // If permission fetch fails, attempt navigation anyway
// //           this.router.navigateByUrl(returnUrl || '/dashboard');
// //         }
// //       });
// //     } else {
