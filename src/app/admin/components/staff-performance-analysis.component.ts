    ...
    this.staffColumns = [
      {
        ...
        cellRenderer: (params: any) => {
          ...
          return `<div style="display: flex; align-items: center; gap: 12px; height: 100%;">
                    <div style="width: 32px; height: 32px; border-radius: 50%; background: var(--theme-bg-ternary); border: 1px solid var(--theme-border-secondary); color: var(--theme-accent-primary); display: flex; align-items: center; justify-content: center; font-weight: 700; font-size: 10px;">
                      ${initials}
                    </div>
      ...
      },
      {
        ...
        cellStyle: (params: any) => {
           return {
             'font-weight': '700',
             'text-align': 'right',
             'color': params.value > 0 ? 'var(--theme-error)' : 'var(--theme-text-tertiary)'
           };
        }
      },
      {
        ...
        type: 'rightAligned',
        valueFormatter: (params: any) => this.commonService.formatCurrency(params.value),
        cellStyle: { 'font-weight': '700', 'color': 'var(--theme-info)', 'text-align': 'right' }
      },
      {
        field: 'totalSales', 
        headerName: 'Revenue', 
        ...
        type: 'rightAligned',
        valueFormatter: (params: any) => this.commonService.formatCurrency(params.value),
        cellStyle: { 'font-weight': '700', 'color': 'var(--theme-success)', 'text-align': 'right', 'font-size': '14px' }
      }
    ];
