      ...
      <ng-container *ngIf="!loading(); else loader">
        ...
        <div class="kpi-grid">
          ...
          <div class="kpi-card exposure-card">
            ...
            <h2 class="kpi-value primary">{{ commonService.formatCurrency(emiSummary()?.totalAmount) }}</h2>
          ...
          <div class="kpi-card revenue-card">
            ...
            <h2 class="kpi-value success">{{ commonService.formatCurrency(emiSummary()?.totalInterestEarned) }}</h2>
...
export class EmiAnalyticsComponent implements OnInit {
  ...
  ngOnInit() {
    this.setupColumns();
    // loadData is triggered via the filter component init
  }
