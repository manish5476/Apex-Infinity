...
@Component({
  ...
  template: `
    <div class="admin-dashboard">
      <!-- Main Header -->
      <header class="dashboard-header glass-surface">
        <div class="header-content">
          <!-- Logo & Title -->
          <div class="brand-section">
            <div class="brand-logo surface-elevated">
              <i class="pi pi-chart-line"></i>
            </div>
            <div class="brand-info">
              <h1 class="brand-title">Analytics Dashboard</h1>
              <p class="brand-subtitle">24 Components • Real-time Monitoring</p>
            </div>
          </div>
          ...
          <div class="user-section">
            <button class="settings-button surface-interactive">
              <i class="pi pi-cog"></i>
            </button>
            <p-avatar 
              label="AD" 
      ...
      <footer class="dashboard-footer glass-surface">
        <div class="footer-content">
          <p-multiSelect 
            [options]="componentOptions" 
            [(ngModel)]="selectedComponents" 
            optionLabel="label" 
            placeholder="Quick Access Components"
            [style]="getSelectorStyle()"
            [maxSelectedLabels]="3">
          </p-multiSelect>
...
export class AdminDashboardComponent implements OnInit, OnDestroy {
  ...
  /**
   * Get selector style object for PrimeNG components
   */
