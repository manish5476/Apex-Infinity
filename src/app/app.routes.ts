...
export const routes: Routes = [
  ...
  // ============================================================
  {
    ...
    children: [
      ...
      { path: 'notes', loadChildren: () => import('./modules/notes/note.routes').then(m => m.NOTE_ROUTES), canActivate: [TabRouterGuard, permissionGuard], data: { permissions: [PERMISSIONS.NOTE.READ] } },
      ...
      { path: 'product', loadChildren: () => import('./modules/product/product.routes').then(m => m.PRODUCT_ROUTES), canActivate: [TabRouterGuard, permissionGuard], data: { permissions: [PERMISSIONS.PRODUCT.READ] } },
      ...
      { path: 'suppliers', loadChildren: () => import('./modules/supplier/supplier.routes').then(m => m.SUPPLIER_ROUTES), canActivate: [TabRouterGuard, permissionGuard], data: { permissions: [PERMISSIONS.SUPPLIER.READ] } },
