...
// // ─────────────────────────────────────────────────────────────────────────────
// // tab-keyboard.service.ts  –  FIX #2: Global keyboard shortcuts for tabs
// // ─────────────────────────────────────────────────────────────────────────────
// //
// // Shortcuts:
// //   Ctrl+W           → close active tab
...
// //
// // Register once in ShellComponent.ngOnInit():
// //   inject(TabKeyboardService).init();
// //
// // ─────────────────────────────────────────────────────────────────────────────
...
//         const target = digit === 9
//           ? tabs[tabs.length - 1]          // Ctrl+9 → always last tab
//           : tabs[digit - 1];               // Ctrl+1 → first, Ctrl+2 → second …
//         if (target) this.tabService.activateTab(target.id);
//       }
//     };
