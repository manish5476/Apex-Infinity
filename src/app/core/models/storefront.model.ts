...
/** Core fields common to all product DTOs */
...
export interface PageSection {
  ...
  // Injected by DataHydrationService at runtime
...
export interface AdminPage extends StorefrontPage {
  ...
  lastViewedAt?: string;
  version: number;
  sectionsCount?: number; // injected in list view
  createdBy?: string;
  createdAt: string;
}
...
export interface SectionDefinition {
  ...
  description: string;
  isSystem: boolean;
  schema: Record<string, SectionFieldDef>;
}
