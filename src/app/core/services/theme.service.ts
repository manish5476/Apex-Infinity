...
//         // 1. Sync isDarkMode from preferences
//         if (user.preferences?.theme) {
//           const isDark = user.preferences.theme === 'dark';
//           if (newSettings.isDarkMode !== isDark) {
//             newSettings.isDarkMode = isDark;
//             hasChanges = true;
//           }
//         }

//         // 2. Sync lightThemeClass from user.themeId
//         if (user.themeId && user.themeId !== 'theme-dark') {
//           // If the DB has a legacy or broken theme ID, fallback to 'theme-light'
//           let incomingTheme = user.themeId;
//           if (!ThemeFontLoader.isValidTheme(incomingTheme)) {
//             incomingTheme = 'theme-light';
//           }
//           if (newSettings.lightThemeClass !== incomingTheme) {
//             newSettings.lightThemeClass = incomingTheme;
//             hasChanges = true;
//           }
//         } else if (user.themeId === 'theme-dark') {
...
//         // 3. Apply changes internally without looping back to the socket
//         if (hasChanges) {
//           this.updateSettings(newSettings, false);
//         }
//       }
...
//         // Sanitize legacy or broken theme IDs from localStorage
//         if (settings.lightThemeClass && !ThemeFontLoader.isValidTheme(settings.lightThemeClass)) {
//           settings.lightThemeClass = this.defaultSettings.lightThemeClass;
//         }
