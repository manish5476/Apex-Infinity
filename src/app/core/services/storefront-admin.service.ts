...
//   // ✅ FIX: Point directly to standard API URL
//   // Result: http://localhost:5000/api/v1/admin/storefront
//   private baseUrl = `${environment.apiUrl}/admin/storefront`;

//   // ... (Keep all your existing methods: getPages, createPage, etc.) ...
...
// //   // ✅ FIX: Use the standard apiUrl (e.g. http://localhost:5000/api/v1) directly
// //   // Backend now listens at: /api/v1/admin/storefront
// //   private baseUrl = `${environment.apiUrl}/admin/storefront`;
...
// // //   // Note: App.js mounts this at /admin/storefront, NOT /api/v1/admin/storefront
// // //   private baseUrl = `${environment.apiUrl.replace('/api/v1', '')}/admin/storefront`;
